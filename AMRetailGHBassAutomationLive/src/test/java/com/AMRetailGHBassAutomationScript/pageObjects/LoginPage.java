...
public class LoginPage 
{
	...
	@FindBy(xpath="//div[@class='block block-customer-login']/div[2]/form/div[2]/div[2]/button")
	...
	public void login()
	{
		...
		WebDriverWait wait1=new WebDriverWait(ldriver, Duration.ofSeconds(10000));
		wait1.until(ExpectedConditions.elementToBeClickable(regpassword)).sendKeys("Test@1234");
