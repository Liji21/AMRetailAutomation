...
WebDriver ldriver;
	...
	@FindBy(xpath="//div[@class='sidebar sidebar-main']/div/div[2]/ul/li[2]")
	WebElement myorderslink;
	
	@FindBy(xpath="//div[@class='sidebar sidebar-main']/div/div[2]/ul/li[3]")
	WebElement mysaveditemslink;
	
	@FindBy(xpath="//div[@class='sidebar sidebar-main']/div/div[2]/ul/li[4]")
	WebElement mydetailslink;
	
	@FindBy(xpath="//div[@class='sidebar sidebar-main']/div/div[2]/ul/li[5]")
	WebElement myaddresseslink;
	
	@FindBy(xpath="//div[@class='sidebar sidebar-main']/div/div[2]/ul/li[6]")
	...
	public void verifylinks()
	{
		...
		wait2.until(ExpectedConditions.elementToBeClickable(mydashboardlink)).click();
