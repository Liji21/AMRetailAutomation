...
public class CheckoutPage 
{
	...
	@FindBy(xpath="//div[@class='swatch-attribute dkny_sku_size']/div[3]/div[2]")
	WebElement sizeswatch;
	
	public void addtocart()
	{
		ldriver.get("https://www.dkny.com/donnakaran/printed-ruched-side-dress#dkny_sku_color=21699");
