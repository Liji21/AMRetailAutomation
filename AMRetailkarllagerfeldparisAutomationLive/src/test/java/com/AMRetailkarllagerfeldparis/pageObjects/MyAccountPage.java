...
WebDriver ldriver;
	...
	@FindBy(xpath="//main[@id='maincontent']/div/div[1]/div/div[2]/ul/li[2]")
	WebElement myorderslink;
	
	@FindBy(xpath="//main[@id='maincontent']/div/div[1]/div/div[2]/ul/li[3]")
	WebElement mysaveditemslink;
	
	@FindBy(xpath="//main[@id='maincontent']/div/div[1]/div/div[2]/ul/li[4]")
	WebElement mydetailslink;
	
	@FindBy(xpath="//main[@id='maincontent']/div/div[1]/div/div[2]/ul/li[5]")
	WebElement myaddresseslink;
	
	@FindBy(xpath="//main[@id='maincontent']/div/div[1]/div/div[2]/ul/li[6]")
	WebElement logoutlink;
	
	public void verifylinks()
	{
		WebDriverWait wait1=new WebDriverWait(ldriver, Duration.ofSeconds(1000));
		wait1.until(ExpectedConditions.elementToBeClickable(mydashboardlink)).isDisplayed();
